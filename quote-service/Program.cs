...
builder.Services.AddDbContext<AppDbContext>(opt => opt.UseInMemoryDatabase("Quote"));
builder.Services.AddScoped<IQuoteRepo, QuoteRepo>();
builder.Services.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies());
builder.Services.AddHttpClient<QuoteController>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c => 
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "QuoteService v1");
    });
}
