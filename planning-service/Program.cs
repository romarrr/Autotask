...
using PlanningService.Controllers;
...
builder.Services.AddDbContext<AppDbContext>(opt => opt.UseInMemoryDatabase("Planning"));
builder.Services.AddScoped<IPlanningRepo, PlanningRepo>();
builder.Services.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies());
builder.Services.AddHttpClient<PlanningController>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c => 
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "PlanningService v1");
    });
}
