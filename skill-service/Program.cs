...
using SkillService.Controllers;
...
builder.Services.AddDbContext<AppDbContext>(opt => opt.UseInMemoryDatabase("Skill"));
builder.Services.AddScoped<ISkillRepo, SkillRepo>();
builder.Services.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies());
builder.Services.AddHttpClient<SkillController>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c => 
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "SkillService v1");
    });
}
